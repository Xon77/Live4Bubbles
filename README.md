...
It transforms your live coding setup into a **performance system** with control over your rhythmic, spectral and spatial patterns of sound files and SuperCollider synthesis in real-time.
