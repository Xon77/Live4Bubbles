...
Both tools allow you to assemble, modify, and layer multiple code fragments from databases via graphical interfaces and controllers, creating a hybrid form between computer-assisted composition and traditional live coding. The performance relies on real-time assembly of multiple fragments of code (rhythmic, effects, patterns), their accumulation in layered stacks, and gestural control of their dozens of parameters.
...
Optional:
- [pulsar-tidalcycles variation](https://github.com/Xon77/pulsar-tidalcycles) - You can use my variation of pulsar-tidalcycles which adds the ability to select lines from different splits, in addition to the original feature of selecting from different tabs. You can also find or add the code changed via [this link](https://github.com/tidalcycles/pulsar-tidalcycles/compare/master...Xon77:pulsar-tidalcycles:master),
- [SuperCollider sc3-plugins](https://supercollider.github.io/sc3-plugins) for extended synthesis capabilities,
- [Mi-UGens](https://github.com/v7b1/mi-UGens) - SuperCollider UGens based on [Mutable Instruments](https://pichenettes.github.io/mutable-instruments-documentation/) eurorack modules.
...
- [Lines 25-27](L4B_SC/L4B_SC_Project/_0T_Init_TidalX.scd#L25-L27): GUI size parameters for 4 tracks (see [lines 30-33](L4B_SC/L4B_SC_Project/_0T_Init_TidalX.scd#L30-L33) for 8 tracks configuration)
- [Lines 36-37](L4B_SC/L4B_SC_Project/_0T_Init_TidalX.scd#L36-L37): Window position (X, Y coordinates)
...
[**Notes sur l'utilisation de l'IA**](https://github.com/Xon77/Live4Bubbles/wiki/AI-Notes)
