...
It transforms your live coding setup into a **performance and control system** with control over your rhythmic, spectral and spatial patterns of sound files and SuperCollider synthesis in real-time, that leverages all available open-source online resources, pushing the boundaries of digital creation.
