...
-- https://github.com/cleary/livecode/blob/main/synths/superfm/1.tidal
-- miUgens busses experiment
    -- makeBus name busId pat = pF name pat # pI ("^" ++ name) busId -- already in FM
    -- makeRecv name busId = pI ("^ ++ name") busId -- already in FM
