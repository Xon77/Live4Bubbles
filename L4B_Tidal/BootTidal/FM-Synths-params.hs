-- https://club.tidalcycles.org/t/superfm/1761



-- https://gist.github.com/loopier/2535109e5d64cc43f56475d902cda905
-- FM original Parameters from Loopier (Roger Pibernat)
    -- modulators
let mod11 = pF "mod11"
    mod12 = pF "mod12"
    mod13 = pF "mod13"
    ...
    eglevel11 = pF "eglevel11" -- atkl1 : attack level for operator 1, instead of eglelvel11 ?
    eglevel12 = pF "eglevel12" -- decl1 : ecay level for operator 1, instead of eglelvel12 ?
    eglevel13 = pF "eglevel13" -- susl1 : sustain level for operator 1, instead of eglelvel13 ?
    eglevel14 = pF "eglevel14" -- rell1 : release level for operator 1, instead of eglelvel14 ?
    ...
    egrate11 = pF "egrate11" -- atkr1 : attack rate for operator 1, instead of egrate11 ?
    egrate12 = pF "egrate12" -- decr1 : decay rate for operator 1, instead of egrate12 ?
    egrate13 = pF "egrate13" -- susr1 : sustain rate for operator 1, instead of egrate13 ?
    egrate14 = pF "egrate14" -- relr1 : release rate for operator 1, instead of egrate14 ?
...
-- SuperFM control buses from mistertim (Tim Cowlishaw)
-- https://club.tidalcycles.org/t/superfm/1761/48
...
-- FM parameters with arrays from Ghales
-- https://club.tidalcycles.org/t/superfm/1761/19
-- Parameters
...
-- let fmparam function (x:xs) = foldr (#) (function 1 x) (zipWith function [2..] xs) -- proposal from Paul1 -- interest ?
    lfma = fmparam fmamp -- fmamps better ?
...
-- FM algorithm selection function for superfm from snutfejs, based on GHEIKA’s footwork selection function
-- https://www.youtube.com/watch?v=oJSWNKUqgmM&t=845s
-- https://club.tidalcycles.org/t/superfm/1761/53
-- impossible to evaluate like in the text -- parse error (possibly incorrect indentation or mismatched brackets) -- Why ???
let
  algs = [ lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 3 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 2 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 2 4 1 # fmmod 4 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 1 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 2 3 1 # fmmod 1 4 1 # fmmod 4 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 3 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,1,0,0,0,0] # fmmod 2 3 1 # fmmod 3 4 1, lfma [1,1,0,0,0,0] # fmmod 2 3 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,1,0,0,0,0] # fmmod 1 3 1 # fmmod 2 3 1 # fmmod 3 4 1, lfma [1,1,0,0,0,0] # fmmod 1 3 1 # fmmod 2 3 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,0,1,0,0,0] # fmmod 1 2 1 # fmmod 3 4 1, lfma [1,0,1,0,0,0] # fmmod 1 2 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,1,0,0,0,0] # fmmod 2 3 1 # fmmod 2 4 1, lfma [1,1,0,0,0,0] # fmmod 2 3 1 # fmmod 2 4 1 # fmmod 4 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 1 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 1 4 1 # fmmod 4 4 1, lfma [1,1,1,0,0,0] # fmmod 3 4 1, lfma [1,1,1,0,0,0] # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,1,1,0,0,0] # fmmod 1 4 1 # fmmod 2 4 1 # fmmod 3 4 1, lfma [1,1,1,0,0,0] # fmmod 1 4 1 # fmmod 2 4 1 # fmmod 3 4 1 # fmmod 4 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 2 4 1 # fmmod 3 4 1, lfma [1,0,0,0,0,0] # fmmod 1 2 1 # fmmod 1 3 1 # fmmod 2 4 1 # fmmod 3 4 1 # fmmod 4 4 1 ]
